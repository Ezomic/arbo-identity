...
* @see app/Http/Controllers/Tenants/TenantRegistrationController.php:17
...
* @see app/Http/Controllers/Tenants/TenantRegistrationController.php:22
* @route '/tenants'
*/
...
const TenantRegistrationController = { create, store }
